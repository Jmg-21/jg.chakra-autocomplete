...
import { IconProps, CheckCircleIcon, Search2Icon } from '@chakra-ui/icons'
...
function defaultOptionFilterFunc<T>(items: T[], inputValue: string) {
  return matchSorter(items, inputValue, {
    keys: ['value', 'label', 'firstname', 'lastname', 'middlename', 'uuid']
  })
}
...
export const CUIAutoComplete = <T extends Item>(
  ...
  return (
    <Stack>
      <FormLabel textAlign='center' {...getLabelProps({})}>
        {label}
      </FormLabel>
